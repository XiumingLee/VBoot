  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <!-- <div class="tips">
        ...
        <el-button type="primary" style="width:100%;" @click.native.prevent="test">vuex测试</el-button>
      </div> -->
    </el-form>
  </div>
</template>
  ...
  methods: {
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          this.loading = true;
          this.$formPost("/login", this.loginForm)
            .then(res => {
